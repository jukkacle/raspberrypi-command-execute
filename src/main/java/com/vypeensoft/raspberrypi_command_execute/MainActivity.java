...
public class MainActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    try { 
        ...
        oneLine1 = "|2|Rasp 2 - restart deluge|/home/pi/Deluge_restart.sh";
        FileUtil.appendStringToFile(this, getString(R.string.command_file_name), oneLine1);

        oneLine1 = "|3|Rasp 3 - restart Curl|/home/pi/Curl_restart.sh";
        FileUtil.appendStringToFile(this, getString(R.string.command_file_name), oneLine1);

        oneLine1 = "|4|Rasp 4 - restart Curl|/home/pi/Curl_restart.sh";
        FileUtil.appendStringToFile(this, getString(R.string.command_file_name), oneLine1);
